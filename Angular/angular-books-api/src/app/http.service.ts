...
export class HttpService {
  ...
  // getAuthor(_id: number): Observable<Author> {
  //   console.log('service got the request to get author', _id);
  //   return this._http.get<Author>(`./authors/${_id}`);
  // }
  // getBook(_id: number): Observable<Book> {
  //   console.log('service got the request to get book', _id);
